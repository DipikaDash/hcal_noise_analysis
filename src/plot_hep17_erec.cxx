...
{ 
  ...
  {
    cout << ibin << " " << h1->GetXaxis()->GetBinUpEdge(ibin) <<  " " << h1->GetXaxis()->GetBinLowEdge(ibin) << " " << h1->GetBinContent(ibin) << endl;
      ...
      for(int iphi=63; iphi<67; iphi++)
      {
        for(int depth=1; depth<8; depth++)
        {
          ...
          { 
            ...
            h1_zero[ieta-16][iphi-63][depth-1]->GetXaxis()->SetRange(1,10); 
          }
          else 
          { 
          ...
          if(infile->Get(Form("h1_jetht_erec_ieta%i_iphi%i_depth%i_nvtx%i", ieta,iphi,depth,invtx)))
          {
            ...
            h1_jetht[ieta-16][iphi-63][depth-1]->GetXaxis()->SetRange(1,10); 
          }
          else 
          { 
          ...
          if(infile->Get(Form("h1_met_erec_ieta%i_iphi%i_depth%i_nvtx%i", ieta,iphi,depth,invtx)))
          {
            ...
            h1_met[ieta-16][iphi-63][depth-1]->GetXaxis()->SetRange(1,10); 
          }
          else 
          { 
          ...
          if(infile->Get(Form("h1_pion_erec_ieta%i_iphi%i_depth%i_nvtx%i", ieta,iphi,depth,invtx)))
          {
            ...
            h1_pion[ieta-16][iphi-63][depth-1]->GetXaxis()->SetRange(1,10); 
          }
          else 
          { 
