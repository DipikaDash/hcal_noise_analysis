...
OBJECTS := $(addprefix $(OBJDIR)/, $(addsuffix .o, $(notdir $(basename $(wildcard $(SRCDIR)/*.cpp))))) $(OBJDIR)/hcal_tree.o 
...
$(EXEDIR)/generate_hcal_tree.exe: $(OBJDIR)/generate_hcal_tree.o
	$(LINK)
...
# Auto-generated code
.SECONDARY: dummy_hcal_tree.all 
.PRECIOUS: generate_hcal_tree.o 

$(SRCDIR)/hcal_tree.cpp $(INCDIR)/hcal_tree.hpp: dummy_hcal_tree.all
dummy_hcal_tree.all: $(EXEDIR)/generate_hcal_tree.exe 
	./$< -t
